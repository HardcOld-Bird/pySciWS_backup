...
output1 = extract_single_tone_information_vvi(
    test_wf, approx_freq=3400.0, precise_mode=False
)
...
output2 = extract_single_tone_information_vvi(
    test_wf, approx_freq=3400.0, precise_mode=True
)
