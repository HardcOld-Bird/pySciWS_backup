...
所有 GET 响应会缓存到 ``skills_src/literature_research/cache/api_responses/``，避免重复请求。

用法示例::

    from skills_src.literature_research.tools.openalex_client import search_works, get_work
