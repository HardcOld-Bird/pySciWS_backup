...
用法（在项目根目录）::
    ...
    python -m skills_src.literature_research.tools.research <cmd> [options]
...
4. 所有产物路径基于 settings.module_dir（= skills_src/literature_research/）。
...
# ---------------------------------------------------------------------------
# 路径常量（全部基于模块根 settings.module_dir = skills_src/literature_research/）
# ---------------------------------------------------------------------------
